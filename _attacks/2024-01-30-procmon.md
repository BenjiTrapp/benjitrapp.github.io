...
def log_process_connections(pid):
    try:
        while True:
            ...
            print(tabulate(data, headers=["Timestamp", "Family", "Type", "Local Address", "Remote Address", "Status", "Protocol"]))
...
defender_tool_processes = {
    ...
    "Crowd Strike Falcon": ["csagent", "falconctl", "falconhost", "falcon-sensor", "CSFalconService.exe", "CSFalconContainer.exe", "CSFalconUI.exe", "CSFalconUpdate.exe", "CSFalconSensorService.exe", "CSFalconSensor"],
