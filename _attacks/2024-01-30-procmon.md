...
defender_tool_processes = {
    ...
    "SentinelOne": ["s1-orchestrator", "s1-network", "s1-scanner", "s1-agent", "s1-firewall", # Linux 
                    "sentineld", "sentineld-shell" , "SentinelAgent", "SentinelAgentWorker.exe", "SentinelServiceHost.exe", # Mac
                    "SentinelStaticEngine.exe", "LogProcessorService.exe", "SentinelStaticEngineScanner.exe", "SentinelHelperService.exe", # Windows
                    "SentinelBrowserNativeHost.exe", "com.sentinelone", "sentineld_helper", "sentineld_guard", "com.sentinelone.network-monitoring",  # Generic stuff
