...
## Table of Contents
- [title: Pivoting and Tunneling guide](#title-pivoting-and-tunneling-guide)
...
## Double Pivoting
Double pivoting involves using SSH Dynamic Port Forwarding and Proxychains to reach multiple intermediate hosts.
