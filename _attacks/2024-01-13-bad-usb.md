...
Below you find a script for retrieving a LSASS dump using the sysinternals procdump tool. The looted dump file is automatically send to an email address which can be configured in the variables.
